...
cd /opt/alfresco
find . -print -exec chown -f --reference=/tmp/alfresco-perms/{} {} 2>&1 > /dev/null \; 2>&1 > /dev/null
find . -print -exec chmod -f --reference=/tmp/alfresco-perms/{} {} 2>&1 > /dev/null \; 2>&1 > /dev/null
find /opt/alfresco -uid 109 -exec chown -f alfresco:alfresco {} 2>&1 > /dev/null \; 2>&1 > /dev/null
